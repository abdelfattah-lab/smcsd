...
This repo vendors a patched vllm as a git submodule at `3rdparty/vllm` (branch `vllm-smc` cut from vllm relase branch `releases/v0.20.0`). Install both in editable mode.
